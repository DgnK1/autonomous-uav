...
function createTheme(mode: "light" | "dark") {
  ...
  return {
    isDark,
    colors: {
      screenBg: isDark ? "#111317" : "#e1e3e8",
      headerBg: isDark ? "#171b21" : "#ffffff",
      headerBorder: isDark ? "#262b34" : "#cfd3da",
      textPrimary: isDark ? "#f0f3f8" : "#111111",
      textSecondary: isDark ? "#c8ced8" : "#242830",
      textMuted: isDark ? "#bac3d1" : "#3f454e",
      icon: isDark ? "#e8edf6" : "#111111",
      cardBg: isDark ? "#1b2028" : "#e3e5ea",
      cardBorder: isDark ? "#2b3240" : "#bcc1ca",
      cardAltBg: isDark ? "#1b2028" : "#dde0e6",
      mapCardBg: isDark ? "#2e333d" : "#d8d4ce",
      mapFrameBg: isDark ? "#213042" : "#dce7f1",
      tableHeaderBg: isDark ? "#202731" : "#e1e4ea",
